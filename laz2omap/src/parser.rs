...
pub struct Args {
    ...
    /// Contour interval of map output in the units of input Lidar files, must be at least 1
    ...
    /// Contour interval (in the units of the input) of basemap (analytic contours) min value 0.1, default no basemap
