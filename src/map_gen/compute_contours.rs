...
pub fn compute_naive_contours(
    ...
    loop {
        ...
        score = true_dem.error(&interpolated_dem) + params.contour_algo_lambda * contours.energy(1);
...
// used for raw and smoothed contour extraction, smoothing happens on the DEM level
