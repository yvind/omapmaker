...
impl Matrix6x6{
    ...
    pub fn dot_vec(&self, other: Vector6) -> Vector6{
        ...
        res.data[0] = mat[0][0]*vec[0] + mat[0][1]*vec[1] + mat[0][2]*vec[2] + mat[0][3]*vec[3] + mat[0][4]*vec[4] + mat[0][5]*vec[5];
        res.data[1] = mat[1][0]*vec[0] + mat[1][1]*vec[1] + mat[1][2]*vec[2] + mat[1][3]*vec[3] + mat[1][4]*vec[4] + mat[1][5]*vec[5];
        res.data[2] = mat[2][0]*vec[0] + mat[2][1]*vec[1] + mat[2][2]*vec[2] + mat[2][3]*vec[3] + mat[2][4]*vec[4] + mat[2][5]*vec[5];
        res.data[3] = mat[3][0]*vec[0] + mat[3][1]*vec[1] + mat[3][2]*vec[2] + mat[3][3]*vec[3] + mat[3][4]*vec[4] + mat[3][5]*vec[5];
        res.data[4] = mat[4][0]*vec[0] + mat[4][1]*vec[1] + mat[4][2]*vec[2] + mat[4][3]*vec[3] + mat[4][4]*vec[4] + mat[4][5]*vec[5];
        res.data[5] = mat[5][0]*vec[0] + mat[5][1]*vec[1] + mat[5][2]*vec[2] + mat[5][3]*vec[3] + mat[5][4]*vec[4] + mat[5][5]*vec[5];
    ...
    pub fn inverse_spd(&self) -> Matrix6x6{
        ...
        // m0 = r0 - r1 * m2;
        result.data[0][0] = r0[0][0] - r1[0][0] * result.data[3][0] - r1[0][1] * result.data[4][0] - r1[0][2] * result.data[5][0];
        result.data[0][1] = r0[0][1] - r1[0][0] * result.data[3][1] - r1[0][1] * result.data[4][1] - r1[0][2] * result.data[5][1];
        result.data[0][2] = r0[0][2] - r1[0][0] * result.data[3][2] - r1[0][1] * result.data[4][2] - r1[0][2] * result.data[5][2];
        result.data[1][0] = result.data[0][1];
        result.data[1][1] = r0[1][1] - r1[1][0] * result.data[3][1] - r1[1][1] * result.data[4][1] - r1[1][2] * result.data[5][1];
        result.data[1][2] = r0[1][2] - r1[1][0] * result.data[3][2] - r1[1][1] * result.data[4][2] - r1[1][2] * result.data[5][2];
        result.data[2][0] = result.data[0][2];
        result.data[2][1] = result.data[1][2];
        result.data[2][2] = r0[2][2] - r1[2][0] * result.data[3][2] - r1[2][1] * result.data[4][2] - r1[2][2] * result.data[5][2];
