...
impl Vertex{
    ...
    pub fn get_boundary_dist(&self, other: &Vertex, bounding_box: &Bounds) -> Result<f64, &'static str>{
        ...
        if edge_index1 == 0{ // ymax
            if edge_index2 == 0{ // ymax
                if other.x <= self.x{
                    ...
                    return Ok(self.x - bounding_box.min.x + side_length_y + side_length_x + side_length_y + bounding_box.max.x - other.x);
                }
            }
            else if edge_index2 == 1{ // xmax
                return Ok(self.x - bounding_box.min.x + side_length_y + side_length_x + other.y - bounding_box.min.y);
            }
            else if edge_index2 == 2{ // ymin
                return Ok(self.x - bounding_box.min.x + side_length_y + other.x - bounding_box.min.x);
            }
            ...
            if edge_index2 == 0{
                ...
                if other.y >= self.y{
                    ...
                    return Ok(bounding_box.max.y - self.y + side_length_x + side_length_y + side_length_x + other.y - bounding_box.min.y);
                }
            }
            else if edge_index2 == 2{
                return Ok(bounding_box.max.y - self.y + side_length_x + side_length_y + other.x - bounding_box.min.x);
            }
            else if edge_index2 == 3{
                return Ok(bounding_box.max.y - self.y + side_length_x + bounding_box.max.y - other.y);
            }
            else{
                return Err("Boundary distance error?");
            }
            ...
            if edge_index2 == 0{
                return Ok(bounding_box.max.x - self.x + side_length_y + bounding_box.max.x - other.x);
            }
            else if edge_index2 == 1{
                ...
                if other.x >= self.x{
                    ...
                    return Ok(bounding_box.max.x - self.x + side_length_y + side_length_x + side_length_y + other.x - bounding_box.min.x);
                }
                
            }
            else if edge_index2 == 3{
                return Ok(bounding_box.max.x - self.x + side_length_y + side_length_x + bounding_box.max.y - other.y);
            }
            else{
                return Err("Boundary distance error?");
            }
            ...
            if edge_index2 == 0{
                return Ok(self.y - bounding_box.min.y + side_length_x + side_length_y + bounding_box.max.x - other.x);
            }
            else if edge_index2 == 1{
                return Ok(self.y - bounding_box.min.y + side_length_x + other.y - bounding_box.min.y);
            }
            else if edge_index2 == 2{
                ...
                if other.y <= self.y{
                    ...
                    return Ok(self.y - bounding_box.min.y + side_length_x + side_length_y + side_length_x + bounding_box.max.y - other.y);
                }
            }
            else{
                return Err("Boundary distance error?");
